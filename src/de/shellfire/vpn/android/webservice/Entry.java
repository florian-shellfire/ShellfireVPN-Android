...
public class Entry implements java.io.Serializable {
	...
	public Entry(SoapObject entrySoap) {
		int i = 0;
		this.boolEntry = (Boolean) entrySoap.getProperty(i++);
		this.starEntry = (Boolean) entrySoap.getProperty(i++);
		this.stringEntry = (Boolean) entrySoap.getProperty(i++);

		
		this.bool = (Boolean) entrySoap.getProperty(i++);

		SoapObject starSoap = (SoapObject)  entrySoap.getProperty(i++);
		if (starEntry && starSoap != null)
			star = new Star(starSoap);
		
		text =  (String) entrySoap.getProperty(i++);
