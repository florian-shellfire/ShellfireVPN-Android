...
public class WsRegistrationResult implements java.io.Serializable {
	...
	public WsRegistrationResult(SoapObject resultObj) {
		int i = 0;
		this.registrationOk = (Boolean) resultObj.getProperty(i++);
		this.errorMessage = (String) resultObj.getProperty(i++);
		this.token = (String) resultObj.getProperty(i++);
	}
