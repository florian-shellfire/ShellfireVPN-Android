...
package de.shellfire.vpn.android.billing;
...
public class IabHelper {
	...
	public void launchPurchaseFlow(Activity act, String sku, String itemType, int requestCode, OnIabPurchaseFinishedListener listener, String extraData) {
		...
		try {
			...
			if (mService == null) {
				throw new NullPointerException("mService is null at launchPurchaseFlow");
			}
			if (mContext == null) {
				throw new NullPointerException("mContext is null at launchPurchaseFlow");
			}
			...
			result = new IabResult(IABHELPER_ERROR_BASE, "NullPointerException while starting purchase flow");
			if (listener != null)
				listener.onIabPurchaseFinished(result, null);			
	    }
	}
...
/**
	...
	void logError(String msg) {
		...
		VpnStatus.logError("In-app billing error: " + msg);
	}

	void logWarn(String msg) {
		Log.w(mDebugTag, "In-app billing warning: " + msg);
		VpnStatus.logError("In-app billing warning: " + msg);
	}
}
