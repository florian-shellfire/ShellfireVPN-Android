...
public class OutlineTextView extends TextView {
	...
	public void init(AttributeSet attrs){
		...
		if(attrs != null){
			...
			if(a.hasValue(R.styleable.OutlineTextView_background)){
				Drawable background = a.getDrawable(R.styleable.OutlineTextView_background);
				if(background != null){
					this.setBackgroundDrawable(background);
				}else{
					this.setBackgroundColor(a.getColor(R.styleable.OutlineTextView_background, 0xff000000));
				}
			}
			...
			if(a.hasValue(R.styleable.OutlineTextView_strokeColor)){
				float strokeWidth = a.getFloat(R.styleable.OutlineTextView_strokeWidth, 1);
