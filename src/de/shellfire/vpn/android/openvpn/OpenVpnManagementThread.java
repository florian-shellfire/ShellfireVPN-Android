...
public class OpenVpnManagementThread implements Runnable, OpenVPNManagement {
	...
	public boolean openManagementInterface(Context c) {
		...
		// The mServerSocketLocal is transferred to the LocalServerSocket,
		// ignore warning
	...
	private void protectFileDescriptor(FileDescriptor fd) {
		...
		try {
			...
			// You can even get more evil by parsing toString() and extract the
			// int from that :)
	...
	private void processLogMessage(String argument) {
		...
		/*
		 * (b) zero or more message flags in a single string: I -- informational
		 * F -- fatal error N -- non-fatal error W -- warning D -- debug, and
		 */
		// 2 log message
	...
	private boolean sendTunFD(String needed, String extra) {
		...
		try {
			...
			// The API documentation fails to mention that it will not reset the
			// file descriptor to
